...
class TestZfsEncryption(unittest2.TestCase):
    ...
    def test_raw(self):
        ...
        self.prepare_encrypted_dataset("11111111", "test_source1/fs1/encryptedsourcekeyless",
...
""")
    ...
    def test_raw_invalid_snapshot(self):
        ...
        with mocktime("20101111000001"):
            ...
            self.assertEqual(ZfsAutobackup("test test_target1 --verbose --no-progress --allow-empty".split(" ")).run(),
                             1)
