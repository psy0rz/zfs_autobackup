...
class TestBlockHasher(unittest2.TestCase):
    ...
    def test_empty(self):
        ...
        self.assertEqual(
            list(block_hasher.generate("data/empty")),
            []
        )
    ...
    def test_partial(self):
        block_hasher = BlockHasher(count=1)
        self.assertEqual(
            list(block_hasher.generate("data/partial")),
    ...
    def test_whole(self):
        block_hasher = BlockHasher(count=1)
        self.assertEqual(
            list(block_hasher.generate("data/whole")),
    ...
    def test_whole2(self):
        block_hasher = BlockHasher(count=1)
        self.assertEqual(
            list(block_hasher.generate("data/whole_whole2")),
            [
                (0, "3c0bf91170d873b8e327d3bafb6bc074580d11b7"),
    ...
    def test_wwp(self):
        block_hasher = BlockHasher(count=1)
        self.assertEqual(
            list(block_hasher.generate("data/whole_whole2_partial")),
            [
    ...
    def test_blockhash_compare(self):
        #no errors
        block_hasher = BlockHasher(count=1)
        generator = block_hasher.generate("data/whole_whole2_partial")
        self.assertEqual([], list(block_hasher.compare("data/whole_whole2_partial", generator)))
        ...
        self.assertEqual(
            ...
            list(block_hasher.compare("data/whole", generator)))
        ...
        block_hasher = BlockHasher(count=1)
        checksums = list(block_hasher.generate("data/whole_whole2_partial"))
        checksums.reverse()
        self.assertEqual([], list(block_hasher.compare("data/whole_whole2_partial", checksums)))
